...
copyright = f"{_build_date:%Y}, Hasan Sezer Taşan"  # ruff: ignore[builtin-variable-shadowing]
...
# superpowers/ holds internal design/planning docs (ported from the source
# repo), not part of the published site, so keep them out of the Sphinx build.
...
html_theme_options = {
    "accent_color": "amber",
    "github_url": "https://github.com/hasansezertasan/nur",
}
...
# subcommands) generated from the live ``nur.cli.app`` app; the
